...
export default function DermaCareHome() {
    const scrollRef = useRef<FlatList<{ id: string; user: string; text: string }>>(null);
    ...
    const navigateTo = (screen: string) => {
        if (screen === "Scan") router.push("/");
        if (screen === "Login") router.push("/auth/login");
        if (screen === "Register") router.push("/auth/register");
    };

    const handleLogout = async () => {
        await logoutUser(); // clears tokens from AsyncStorage
            ...
            <ScrollView showsVerticalScrollIndicator={false} bounces={false}>
                ...
                <View style={styles.sectionContainer}>
                    ...
                    <Text style={styles.sectionText}>
                        ...
                        🧠 AI-Powered Accurate Detection<br></br>
                        DermaCare AI uses advanced machine learning models trained on dermatological images to help identify skin conditions quickly and accurately. <br></br>
                        ⏱️ Instant Results, Anytime<br></br>
                        Upload an image and get instant insights—no waiting rooms, no delays. Early detection can make a real difference in treatment.<br></br>
                        {/* 📍 Smart Hospital & Doctor Recommendations<br></br>
Based on the predicted skin condition and your location (live or manual), DermaCare AI suggests the best nearby hospitals and dermatologists, sorted by rating and distance.<br></br>
👨‍⚕️ Disease-Specific Expertise<br></br>
We don’t just list hospitals—we recommend doctors and medical centers specialized in your predicted skin condition. */}
                    </Text>
                </View>
                ...
                >
                    <View style={styles.bannerOverlay}>
                        ...
                        <Text style={styles.bannerText}>
                            DermaCare AI allows you to track your skin condition history by saving previous scans and results. By comparing images over time, users can monitor improvements, detect worsening symptoms early, and make better-informed decisions before consulting a dermatologist. Having a visual history not only empowers users to take control of their skin health but also provides valuable insights that can be shared with dermatologists for more informed consultations and better treatment decisions.
                        </Text>
                    </View>
                </ImageBackground>
          ...
          />
                ...
                <View style={[styles.sectionContainer, { backgroundColor: COLORS.primaryLight }]}>
                    ...
                    <Text style={styles.sectionText}>
                        ...
                        This isn’t just a one-time scanner — it’s a health tracking tool. That makes DermaCare AI feel more like a long-term companion, not just a diagnostic snapshot.
                    </Text>
                    <TouchableOpacity style={styles.secondaryBtn} onPress={() => navigateTo('Scan')}>
...
const styles = StyleSheet.create({
    ...
    header: {
        ...
        // backgroundColor:"{['#064E3B', '#065F46', '#34D399']}",
        shadowColor: "#000",
    ...
    badge: {
        backgroundColor: 'rgba(33, 165, 7, 0.15)',
        paddingHorizontal: 12,
        paddingVertical: 6,
        borderRadius: 12,
        marginBottom: 20,
        borderWidth: 1,
        borderColor: 'rgba(112, 230, 44, 0.3)',
    },
    badgeText: {
        // color: COLORS.primaryLight,
        color: "rgba(23, 153, 6, 0.9)",
